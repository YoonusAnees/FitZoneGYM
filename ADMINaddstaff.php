...
if (isset($_POST['submit'])) {
    ...
    $UserAddress = $_POST['UserAddress']; // Fixed spelling error (was UserAddrees)
    $Email = $_POST['email'];
    ...
    $target_file = "staffimages/" . basename($fileName);
    $uploadOk = 1;
    ...
    if ($uploadOk == 1 && move_uploaded_file($tempfilename, $target_file)) {
        ...
        try{
            $sql = "INSERT INTO staff (FirstName, LastName, Mobilenumber, UserAddress, Email, Password, image)
        values('$firstName', '$lastName', '$MobileNumber', '$UserAddress', '$Email', '$password', '$fileName')";
...
<body>
    ...
    <section id="upload_container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="UserAddress" id="UserAddress" placeholder="User Address" required>
