  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        ...
        <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="#">FitZon Fitness Staff</a>
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li><a href="#" class="nav-link px-3 active"><span class="me-2"><i class="bi bi-speedometer2"></i></span><span>Staff Dashboard</span></a></li>
            <li class="my-4"><hr class="dropdown-divider bg-light" /></li>
            <li><div class="text-muted small fw-bold text-uppercase px-3 mb-3">Interface</div></li>
            <li><a href="staffmain.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Go To Page</span></a></li>
            <li><a href="staffaddproduct.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Add items</span></a></li>
            <li><a href="showproductsforstaff.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Show items</span></a></li>
        
            <li><a href="addtrainerstaff.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Add Trainer</span></a></li>
            <li><a href="staffShowtrainers.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Show Trainer</span></a></li>
            <li><a href="Staffaddclasses.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Add Classes</span></a></li>
            <li><a href="Staffshowclasses.php" class="nav-link px-3"><span class="me-2"><i class="bi bi-book-fill"></i></span><span>Show Classes</span></a></li>
            <li class="my-4"><hr class="dropdown-divider bg-light" /></li>
          </ul>
        </nav>
      </div>
